...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@700&family=Passion+One&family=Quicksand:wght@400;500;600;700&display=swap"
        rel="stylesheet">
</head>
...
<body>
    ...
    <main class="main1">
        <div class="">
            <form action="luu.php" method="POST" class="form1" id="form-1">
                ...
                <div class="form-group">
                    ...
                    <input id="email" name="email" type="text" placeholder="VD: email@.com" class="form-control">
                    <span class="form-message"></span>
